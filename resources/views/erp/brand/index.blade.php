    ...
    <div class="layui-fluid">
        <div class="layui-card">
            <div class="layui-card-header layuiadmin-card-header-auto">
                <button class="layui-btn layuiadmin-btn-tags" data-type="add" onclick="category_show('添加品牌','{{url("admins/brand/create")}}',2,'500px','600px');">添加品牌</button>
            </div>
        ...
        layui.use(['table','layer'], function(){
            ...
            table.render({
                ...
                ,cols: [[ //表头
                    ...
                    ,{field: 'brand_title', title: '品牌简介', width:180}
                    ,{field: 'brand_pic', title: '品牌图片', event: 'show_img', align:'center',templet: function(res){
                        return '<img src="'+ res.brand_pic +'"width="150px"  alt="">'
                    }}
