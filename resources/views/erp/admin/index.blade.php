    ...
    <div class="layui-fluid">
        <div class="layui-card">
            <div class="layui-card-header layuiadmin-card-header-auto">
                <button class="layui-btn layuiadmin-btn-tags" data-type="add" onclick="category_show('添加管理员','{{url("admins/admin/create")}}',2,'500px','600px');">添加管理员</button>
            </div>
        ...
        layui.use(['table','layer'], function(){
            ...
            table.render({
                ...
                ,cols: [[ //表头
                    ...
                    ,{field: 'admin_name', title: '品牌名称', width:180}
                    ,{field: 'admin_num', title: '登录次数', width:180}
                    ,{field: 'admin_ip', title: '登录IP', width:180}
                    ,{field: 'admin_time', title: '登录时间', width:180}
                    ,{field: 'is_root', title: '超级用户', width: 100, sort: true}
            ...
            table.on('tool(list)', function(obj){
                ...
                if(obj.event === 'detail'){
                    layer.open({
                        ...
                        fixed:false,
                        maxmin:true,
                        content:"{{url('admins/admin/')}}/"+data.admin_id
                    });
                    ...
                    layer.open({
                        ...
                        fixed:false,
                        maxmin:true,
                        content:"{{url('admins/admin/')}}/"+data.admin_id+"/edit"
                    });
