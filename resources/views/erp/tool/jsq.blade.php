...
@section('content')
    <link rel="stylesheet" href="{{asset('/css/jsq/CalcSS3.css')}}">
    <link rel="stylesheet" href="{{asset('/css/jsq/default.css')}}">
    <link rel="stylesheet" href="{{asset('/css/jsq/index.css')}}">
    <link rel="stylesheet" href="{{asset('/css/jsq/normalize.css')}}">
    ...
    <div class="layui-card" style="margin: 0">
        ...
        <div class="jq22-container">
            ...
            <div class="jq22-content">
                <div class="calc-main" style="top: 50%;">
