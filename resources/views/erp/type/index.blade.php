    ...
    <div class="layui-fluid">
        <div class="layui-card">
            <div class="layui-card-header layuiadmin-card-header-auto">
                <button class="layui-btn layuiadmin-btn-tags" data-type="add" onclick="category_show('添加类型','{{url("admins/type/create")}}',2,'500px','600px');">添加类型</button>
            </div>
        ...
        layui.use(['table','layer'], function(){
            ...
            table.render({
                ...
                ,cols: [[ //表头
                    ...
                    ,{field: 'type_english', title: '英文名称', width: 180}
                    ,{field: 'attr_ids', title: '属性ID', width:80}
            ...
            table.on('tool(list)', function(obj){
                ...
                if(obj.event === 'detail'){
                    layer.open({
                        ...
                        fixed:false,
                        maxmin:true,
                        content:"{{url('admins/type/')}}/"+data.id
                    });
                    ...
                    layer.open({
                        ...
                        fixed:false,
                        maxmin:true,
                        content:"{{url('admins/type/')}}/"+data.id+"/edit"
                    });
