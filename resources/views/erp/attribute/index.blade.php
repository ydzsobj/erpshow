    ...
    <div class="layui-fluid">
        <div class="layui-card">
            <div class="layui-card-header layuiadmin-card-header-auto">
                <button class="layui-btn layuiadmin-btn-tags" data-type="add" onclick="category_show('添加属性','{{url("admins/attribute/create")}}',2,'500px','400px');">添加属性</button>
            </div>
        ...
        layui.use(['table','layer'], function(){
            ...
            table.render({
                ...
                ,cols: [[ //表头
                    ...
                    ,{field: 'attr_value', title: '属性值ID', width:120, sort: true}
                    ,{field: 'attr_value_ids', title: '属性值', width:80}
                    ,{field: 'attr_show', title: '属性展示', width: 100, sort: true}
